        ...
        <form method="post">
            <?php
                if(isset($_POST['submit'])){
                    ...
                    $query_update_stok = mysqli_query($koneksi, "UPDATE buku SET stok = stok - 1 WHERE id_buku = $id_buku");
         ...
         <div class="row mb-3">  
           ...
           <input type="hidden" class="form-control" name="status_peminjaman" value="belum dikonfirmasi">
            </div class="row">
